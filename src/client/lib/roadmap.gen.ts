...
export const ROADMAP_PLAN: RoadmapItem[] = [
  ...
  },
  {
    ...
    "status": "next",
    "why": "未収録の人口上位はほぼ政令市（神戸150万・京都144万・さいたま134万・広島119万・仙台109万・千葉・北九州・堺・浜松・新潟・熊本・相模原・岡山・静岡）。6市（横浜・大阪・名古屋・札幌・福岡・川崎）で型が割れており、人口あたりの効きが最大。",
    "needs": "様式が市ごとに違う。大阪は款別一覧が無く事項別明細書に款項目が混在していて専用パーサが要った一方、他5市は款別一覧ページがあり共通パーサに乗った。どちらの型かは実測でしか分からないので、市ごとに source-scout で「款別一覧の有無・ページ番号・Σ款=合計の成立」を確かめてから着手する。",

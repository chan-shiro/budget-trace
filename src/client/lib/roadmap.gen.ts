...
export const ROADMAP_PLAN: RoadmapItem[] = [
  ...
  },
  {
    ...
    "status": "now",
    "why": "未収録の人口上位はほぼ政令市（仙台109万・千葉98万・北九州92万・堺82万・浜松・新潟・熊本・相模原・岡山・静岡）。人口あたりの効きが最大で、10市で全国20政令市が揃う。",
    "needs": "様式が市ごとに違い、実測でしか分からない。収録済み10市で3つの型が出た: 総括が単独ページ（共通パーサに乗る・多数派）／款別一覧が無く事項別明細書に款項目が混在（大阪・専用パーサ）／予算書がスキャンOCR で使えず記者発表資料に逃げる（広島・専用パーサ）。とくにOCR は pdftotext が空にならず「もっともらしい誤数字」を出すので、born-digital かの判定を先にやる。市ごとに source-scout で確かめてから着手する。",

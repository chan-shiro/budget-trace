...
export const SKELETON_BUDGETS: SkeletonBudget[] = [
  ...
  { code: "232041", name: "瀬戸市", fy: "R5", evidence: "「令和5年度当初予算の概要」物理 p.7（印字「- 2 -」）「２ 骨格予算としての編成」「令和５年４月に市長選挙が行われることから、令和５年度の当初予算は、義務的・経常的な経費や継続的に実施している事業の経費を基本とした「骨格予算」として編成し、政策的判断を要する新規事業については、原則、計上していません。」（2026-09-12 に収録した raw から逐語照合）", ref: "docs/data-sources.md §13-38" },
  { code: "012173", name: "江別市", fy: "R5", evidence: "「令和5年度当初予算案概要」（/uploaded/attachment/60037.pdf）物理 p.2「また、市長の改選期にあたるため、当初予算は、いわゆる骨格予算としているが、基本理念に基づいた「まちづくり政策」を推進するため、「えべつ未来戦略」の３つの戦略を中枢に据え、重点的・集中的に事業を進めていく。」（2026-09-25 に自分で取得して逐語照合）", ref: "docs/data-sources.md §13-40" },
  { code: "012173", name: "江別市", fy: "H31", evidence: "「平成31年度当初予算案概要」（/uploaded/attachment/36502.pdf）物理 p.2「また、市長及び市議会議員の改選期にあたるため、当初予算は、いわゆる骨格予算としているが、基本理念に基づいた「まちづくり政策」を推進するため、新たに設定した「えべつ未来戦略」の３つの戦略を政策の中枢に据えて、重点的・集中的に事業を進めていく。」（2026-09-25 に自分で取得して逐語照合。H31 の予算書は見つからず未収録）", ref: "docs/data-sources.md §13-40" },
  { code: "412023", name: "唐津市", fy: "R7", evidence: "「令和7年度当初予算の概要」（/uploaded/attachment/17268.pdf）物理 p.5「令和７年度当初予算は、 １月下旬に市長・市議会議員選挙が実施されたため、義務的な経費を中心とした「骨格予算」として編成した。」（2026-09-27 に自分で取得して逐語照合）", ref: "docs/data-sources.md §13-43" },
  { code: "412023", name: "唐津市", fy: "R3", evidence: "「令和3年度当初予算の概要」（WARP 20230307 の旧サイト /zaisei/zaimuhear/documents/r03tousyogaiyousyo.pdf）物理 p.5「令和３年度当初予算は、１月下旬に市長・市議会議員選挙が実施されたため、義務的な経費を中心とした「骨格予算」として編成した。」（2026-09-27 に自分で取得して逐語照合）", ref: "docs/data-sources.md §13-43" },
  { code: "452033", name: "延岡市", fy: "R4", evidence: "「令和４年度施政方針・予算説明」（/uploaded/attachment/8208.pdf・WARP 20220304）物理 p.35「当初予算の編成にあたっては、１月下旬に市長選挙が行われ、新たな政策等を実施するための予算編成を行ういとまがないことから、当初予算をいわゆる骨格予算とし、今後６月補正予算等で必要な肉付けを行うとの考えのもと、編成作業を行いました。」（2026-09-27 に自分で取得して逐語照合。R4 は未収録＝款別表がウェブに無い）", ref: "docs/data-sources.md §13-43" },
  { code: "452033", name: "延岡市", fy: "H30", evidence: "「平成30年度施政方針・予算説明」（/uploaded/attachment/8216.pdf・WARP 20220304）物理 p.12「本市の平成３０年度当初予算につきましては、市長選挙の日程との関係で、短期間での予算編成となりましたことから、一般会計予算については、原則として経常的な経費や継続事業を主体に、骨格予算として編成いたしました。」（2026-09-27 に自分で取得して逐語照合。H30 は未収録）", ref: "docs/data-sources.md §13-43" },
];

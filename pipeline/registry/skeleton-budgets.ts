...
export const SKELETON_BUDGETS: SkeletonBudget[] = [
  ...
  { code: "360007", name: "徳島県", fy: "R5", evidence: "知事選 2023年4月＝R5 が骨格（registry の徳島県ブロック）", ref: "pipeline/registry/sources.ts 徳島県" },
  ...
  { code: "310000", name: "鳥取県", fy: "R1", evidence: "同上（推移表で括弧付き）", ref: "pipeline/registry/sources.ts 鳥取県" },
  ...
  { code: "180009", name: "福井県", fy: "R1", evidence: "同上", ref: "pipeline/registry/sources.ts 福井県" },
  { code: "180009", name: "福井県", fy: "H27", evidence: "同上", ref: "pipeline/registry/sources.ts 福井県" },
  ...
  { code: "012076", name: "帯広市", fy: "H26", evidence: "同上", ref: "docs/data-sources.md §13-25" },
  { code: "012076", name: "帯広市", fy: "H22", evidence: "同上", ref: "docs/data-sources.md §13-25" },
  ...
  { code: "022021", name: "弘前市", fy: "H30", evidence: "偵察が原典で確認（§13-25）", ref: "docs/data-sources.md §13-25" },
  { code: "022021", name: "弘前市", fy: "H26", evidence: "偵察が原典で確認（§13-25）", ref: "docs/data-sources.md §13-25" },
  ...
  { code: "052019", name: "秋田市", fy: "H29", evidence: "市長選 4年周期（registry の秋田市ブロック）", ref: "pipeline/registry/sources.ts 秋田市" },
  ...
  { code: "122122", name: "佐倉市", fy: "H23", evidence: "registry「H24 = H23 骨格は未収録」", ref: "pipeline/registry/sources.ts 佐倉市" },
  ...
  { code: "202029", name: "松本市", fy: "H24", evidence: "同上", ref: "docs/data-sources.md §13-32" },
  { code: "202029", name: "松本市", fy: "H20", evidence: "同上", ref: "docs/data-sources.md §13-32" },
  { code: "202029", name: "松本市", fy: "H16", evidence: "同上", ref: "docs/data-sources.md §13-32" },
  { code: "202037", name: "上田市", fy: "R8", evidence: "原典 p.4 の脚注「※H22、H26、H30、R4、R8は骨格予算編成」", ref: "docs/data-sources.md §13-29" },
  { code: "202037", name: "上田市", fy: "R4", evidence: "同上", ref: "docs/data-sources.md §13-29" },
  { code: "202037", name: "上田市", fy: "H30", evidence: "同上", ref: "docs/data-sources.md §13-29" },
  { code: "202037", name: "上田市", fy: "H26", evidence: "同上", ref: "docs/data-sources.md §13-29" },
  { code: "202037", name: "上田市", fy: "H22", evidence: "同上", ref: "docs/data-sources.md §13-29" },
  ...
  { code: "282146", name: "宝塚市", fy: "R7", evidence: "市長交代（2025年4月）前の編成。R8 概要は「実質的な骨格予算」扱い（registry の宝塚ブロック）", ref: "docs/data-sources.md §13-17" },
  { code: "282146", name: "宝塚市", fy: "R3", evidence: "市長改選前の編成で政策的経費は6月補正（R4 の prevNote。R3 の原典はスキャン）", ref: "docs/data-sources.md §13-17" },
  ...
  { code: "322032", name: "出雲市", fy: "H21", evidence: "registry「同型の H22（H21 骨格）は空セルで未収録」", ref: "pipeline/registry/sources.ts 出雲市" },
  { code: "332020", name: "倉敷市", fy: "R6", evidence: "R6 概要「継続的な事業に要する経費を中心に計上する骨格予算として編成」", ref: "docs/data-sources.md §13-32" },
  { code: "332020", name: "倉敷市", fy: "R2", evidence: "R3 概要「令和２年度の…６月補正予算による肉付け予算後と比較すると…約４．４％の減少」（原典は肉付けの側だけを言う）", ref: "docs/data-sources.md §13-32" },

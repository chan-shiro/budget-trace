...
export const UNRECORDABLE: UnrecordableRecord[] = [
  ...
  },
  {
    ...
    reason:
      ...
      "予算書と、予算に関する説明書の総括・歳入・歳出14冊のすべてで、金額の表の文字が図形として描かれており、" +
      "文字として取り出せるのは、ほぼ印刷されたページ番号だけになる（歳出14冊の242ページで、ほかに読めるのは数字1つきり）。" +
      "紙のスキャンではない。同じ予算書でも、条文のページと債務負担行為・市債の表は文字として入っていて読める。",

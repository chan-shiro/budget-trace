...
export const SOURCES: SourceEntry[] = [
  ...
  ...([
    ...
    //   ⚠ R7 は骨格予算だが、総括表の前年度列は R7 の**当初**（肉付後 52,100,011 ではない）ことを鎖で確かめた → prevNote 不要（§11k）。
  ...
  ...([
    // 武蔵野市（東京都・団体コード 132039。⚠ 武蔵村山市 132110・西東京市 132292 とは別）。
  ...
  ...([
    ...
    // ⚠ R3 のみ骨格予算（記者発表 p.3）。当年度側なので prevNote は置かない（§11k）。

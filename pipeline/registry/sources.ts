...
export const SOURCES: SourceEntry[] = [
  ...
  ...([
    ...
    //   **パーサ手当て待ち**（`prevBlankAsZero` の当年度版が要る）。unrecordable には記録しない。
    ...
    //   「令和8年度（2026年度）一般会計当初予算資料」（`attachment/107763.pdf` p.1）で
  ...
  ...([
    ...
    //   前年度 Σ が −1 で割れる（error で止まる型）＝**パーサ手当て待ち**。unrecordable には記録しない。
  ...
  ...([
    ...
    // 骨格予算: 収録した6ファイルを `骨格|肉付|市長選` で全文検索して **0件**（自分で実測）。

...
export const SOURCES: SourceEntry[] = [
  ...
  ...([
    ...
    //    H29 以前は「予算書」（第1表のみ）で**前年度列が無い**。いずれも `unrecordable.ts`。
  ...
  ...([
    ...
    //    **H27〜R6 は資料そのものが埼玉県オープンデータポータルに登載されて PDL1.0**（ポータル版と市サイト版が
    //    sha256 一致または本文完全一致であることを偵察が実測）。**R8・H26〜H24 は未登載**なので市サイトの条項。

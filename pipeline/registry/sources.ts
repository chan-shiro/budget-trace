...
export const SOURCES: SourceEntry[] = [
  ...
  ...([
    ...
    // ⚠ **H28 は収録する** — 当年度 128,496,754 が **H29 資料の前年度列と一致**することを収録時に実測した
    //    （H29 は自分の当年度だけが案のまま）。前年度 127,300,000 も H27 資料の当年度と一致。
    //    ただし H29 を入れないので derive の鎖では孤立する（値は上記2方向で裏取り済み）。
    ...
    // ⚠ **R2〜H28 だけ物理ページが1つ手前**（印字ノンブルは全年度 3/4 で、物理とのズレが年度で変わる）。

...
export const SOURCES: SourceEntry[] = [
  ...
  },
  {
    ...
    // ⚠ **R8 は骨格予算**（2026年4月の知事選前。原典 p.2 に「重要な政策的予算を除いた、いわゆる
    //    骨格予算としております」と明記）。千葉 R7・京都 R8 と同型で6月補正（698億円）で肉付けされる。
  ...
  },
  {
    ...
    // ⚠⚠ **県エンティティで初の `open`**。愛媛県オープンデータ利用規約（CC BY 4.0・
    //   /opendata-catalog/policy.html・確認日 2026-07-27）が**本資料に実際に及ぶ** —

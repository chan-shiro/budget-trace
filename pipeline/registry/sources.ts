...
export const SOURCES: SourceEntry[] = [
  ...
  ...([
    ...
    // ⚠⚠ **R7 のウェブ掲載は「（原案）」**＝議会修正（修正案その1「分野別市民会議開催事業費」削除・その2「主権者教育推進事業」
    //   削除）前の額。R8 の前年度列は修正後（総務費 9,935,666 / 教育費 8,076,452 / 予備費 32,514・総額は不変）で、R7 の当年度列
    ...
    //   リンク条項「可能な限りトップページの URL に対してリンクをお願いします」は依頼形＝`noDeepLink` は立てない。

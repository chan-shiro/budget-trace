...
import { parseYokohamaJigyouKeikaku } from "./yokohama-jigyou-keikaku";
...
const PARSERS: Record<string, ParserFn> = {
  ...
  "suginami-jimujigyou-hyouka": parseSuginamiJimujigyouHyouka,
  "yokohama-jigyou-keikaku": parseYokohamaJigyouKeikaku, // 主な事業（款項目つき）・局別 PDF 62本 // 事業報告（成果）・1事業2ページ・款項目事業コードつき
